      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-md w-full p-6 border border-gray-100 dark:border-gray-700 transform transition-all scale-100">
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h3 className="text-lg font-bold text-gray-900 dark:text-white">
              Konfirmasi Keluar Edit Clearance
            </h3>
            <p className="mt-1.5 text-xs sm:text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
              Anda sedang berada di halaman edit Clearance. Apakah Anda ingin melanjutkan edit, menyimpan data, atau membatalkan edit untuk berpindah halaman?
            </p>
          </div>
        </div>
        ...
        <div className="mt-6 flex flex-col sm:flex-row-reverse gap-2.5">
          <button
            ...
            onClick={onClose}
            disabled={isSaving}
            className="w-full sm:w-auto px-4 py-2.5 text-xs font-semibold text-white bg-indigo-600 hover:bg-indigo-700 active:scale-95 rounded-xl shadow-md shadow-indigo-200 dark:shadow-none transition-all flex items-center justify-center gap-1.5 cursor-pointer"
          >
          ...
          <button
            ...
            disabled={isSaving}
            className="w-full sm:w-auto px-4 py-2.5 text-xs font-semibold text-emerald-700 dark:text-emerald-300 bg-emerald-50 hover:bg-emerald-100 dark:bg-emerald-950/60 dark:hover:bg-emerald-900/80 border border-emerald-200 dark:border-emerald-800/80 rounded-xl transition-all flex items-center justify-center gap-1.5 disabled:opacity-50 cursor-pointer"
          >
            {isSaving ? (
              <>
